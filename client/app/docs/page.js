      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
          ...
          <div className="stat bg-base-100 shadow-lg rounded-box">
            ...
            <div className="stat-desc">React 19 + TailwindCSS</div>
          </div>
          <div className="stat bg-base-100 shadow-lg rounded-box">
          ...
          <div className="stat bg-base-100 shadow-lg rounded-box">
            ...
            <div className="stat-value text-2xl">Web3</div>
            <div className="stat-desc">Wallet Signatures + JWT</div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base-content/80">
                  ...
                  authentication, JWT for session management, and IPFS/Cloudinary for decentralized storage.
                </p>
              </div>
        ...
        <div className="card bg-base-100 shadow-xl mb-8">
          <div className="card-body">
            ...
            <div className="space-y-4">
              <p className="text-base-content/80">
                Implements Web3-native authentication using wallet signatures and nonce verification.
              </p>
              ...
              <div className="alert alert-info">
                ...
                <span>
                  ...
                  Signatures are verified server-side using ethers.js cryptographic functions.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="card-body">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono">Story Protocol Testnet</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-xs">https://testnet.storyrpc.io</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div>
                ...
                <div className="mockup-code text-xs">
                  <pre><code># Frontend (.env.local)</code></pre>
                  <pre><code>NEXT_PUBLIC_API_ENDPOINT=http://localhost:3001</code></pre>
                  <pre><code>NEXT_PUBLIC_RPC_URL=https://testnet.storyrpc.io</code></pre>
                  <pre><code>NEXT_PUBLIC_CHAIN_ID=1513</code></pre>
                  <pre><code></code></pre>
                  <pre><code># Backend (.env)</code></pre>
                  <pre><code>RPC_URL=https://testnet.storyrpc.io</code></pre>
                  <pre><code>MONGODB_URI=mongodb://localhost:27017/klaimit</code></pre>
        ...
        <div className="card bg-primary text-primary-content shadow-xl">
          <div className="card-body">
            <h2 className="card-title text-2xl mb-4">Additional Resources</h2>
